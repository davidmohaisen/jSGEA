...
base = "/home/ahmed/Documents/Projects/IOT-CFG-ATTACK-Journal/Dataset/"
saveBase = "/home/ahmed/Documents/Projects/IOT-CFG-ATTACK-Journal/Pickles/"
...
for l1 in range(len(FamilyNames)):
    ...
    print(x_all.shape)
    f = open(saveBase+FamilyNames[l1],"wb")
    pickle.dump(x_all,f)
