...
# Fit the model
model.fit(samples,classes, epochs=60, batch_size=32)
...
with open("../subgraph_Isomorphic/model/Model.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("../subgraph_Isomorphic/model/Model.h5")
print("model saved")
