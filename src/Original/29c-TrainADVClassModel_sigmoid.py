...
with open("../ModelData/adversarial pickles/model/Model_sigmoid.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("../ModelData/adversarial pickles/model/Model_sigmoid.h5")
print("model saved")
