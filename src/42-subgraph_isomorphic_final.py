...
with open("../subgraph_Isomorphic/model/Model_softmax_remove_zero_sigmoid.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("../subgraph_Isomorphic/model/Model_softmax_remove_zero_sigmoid.h5")
print("model saved")
