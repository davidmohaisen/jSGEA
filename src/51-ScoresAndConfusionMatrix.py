...
y_true = y_test
y_pred = clf.predict(x_test)
print("RF",clf.score(x_test, y_test),f1_score(y_true, y_pred,average="weighted"))
...
y_true = y_test
y_pred = np.argmax(model.predict(x_test_n),axis=1)
print('DNN', scores[1],f1_score(y_true, y_pred,average="weighted"))
co = confusion_matrix(y_true, y_pred)
DrawConfusionMatrix(co)
# CNN
x_train_n = np.reshape(x_train,(x_train.shape[0],x_train.shape[1],1))
...
y_true = y_test
y_pred = np.argmax(model.predict(x_test_n),axis=1)
print('CNN', scores[1],f1_score(y_true, y_pred,average="weighted"))
co = confusion_matrix(y_true, y_pred)
DrawConfusionMatrix(co)
