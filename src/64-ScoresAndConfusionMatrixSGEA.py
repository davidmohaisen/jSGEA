...
def read_data(FamilyNames,Base,Family,Size,label,detection=True):
...
def read_data_Detection(FamilyNames,Base,Size,detection=True):
...
for Size in Sizes:
    print(Size)
    # Detection
    x_train,y_train,x_test,y_test = read_data_Detection(FamilyNames,Base,Size,detection=True)
    # print(x_train.shape)
    # print(y_train.shape)
    # print(x_test.shape)
    # print(y_test.shape)
    # # LR
    # f = open("../Models/Detection/LR","rb")
    # clf = pickle.load(f)
    # print("LR",clf.score(x_test, y_test))
    #
    # # SVM
    # f = open("../Models/Detection/SVM","rb")
    # clf = pickle.load(f)
